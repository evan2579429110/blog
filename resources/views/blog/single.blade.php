    ...
    <div id="main">
        <div class="wrapper clearfix">
            ...
            <div id="posts-list" class="single-post">
                    <a href="{{url('blog/'.$article_id.'/edit')}}">update</a>
                <h2 class="page-heading"><span>BLOG</span></h2>

                <article class="format-standard">
                    <div class="entry-date">

                        <div class="number">{{$article->updated_at->format('d')}}</div>
                        <div class="year">{{$article->updated_at->format('Y-m')}}</div>
                    </div>
                    ...
                    <div class="meta">
                        <div class="categories"> {{$article->type}}</div>
                        <div class="comments"><a href="#">5 comments </a></div>
                        <div class="user"><a href="#">By {{$user_name}}</a></div>
                    </div>
